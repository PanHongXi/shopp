<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\shopp/application/index\view\goods\goodsdetails.html";i:1532350842;s:61:"D:\wamp64\www\shopp/application/index\view\common\header.html";i:1531574270;s:61:"D:\wamp64\www\shopp/application/index\view\common\footer.html";i:1531621520;}*/ ?>
<!doctype html>
<html>
<head>
...
var load_icon = '<img src="__INDEX__/img/load.gif" width="200" height="200">';
    ...
    //立即购买路径
    var ajaxAddCart = "<?php echo url('index/Flow/addToCart'); ?>";

    //购物车列表路径
    var ajaxCartList1 = "<?php echo url('index/Flow/flow1'); ?>";

</script>
<link rel="stylesheet" type="text/css" href="./css/goods_fitting.css" />
...
<style>
    ...
    label.radiochecked i{
        ...
        background-image: url("__INDEX__/img/dui.png");
    }
</style>
</head>
<body>
...
<div class="preview" if="preview">
	<div class="gallery_wrap">
        <a href="__UPLOADS__/<?php echo $goodsInfo['og_thumb']; ?>" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;">
		    <img src="__UPLOADS__/<?php echo $goodsInfo['og_thumb']; ?>" id="J_prodImg" alt="<?php echo $goodsInfo['goods_name']; ?>">
        </a>
    </div>
	<div class="spec-list">
		...
		<div class="spec-items">
			<ul>
                <?php if(is_array($goodsPhoneList) || $goodsPhoneList instanceof \think\Collection || $goodsPhoneList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhoneList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$midPhone): $mod = ($i % 2 );++$i;?>
                    <li>
                        <a href="__UPLOADS__/<?php echo $midPhone['og_photo']; ?>" rel="zoom-id: Zoomer" rev="__UPLOADS__/<?php echo $midPhone['og_photo']; ?>">
                            <img src="__UPLOADS__/<?php echo $midPhone['mb_photo']; ?>" alt="" width="58" height="58" />
                        </a>
                    </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
...
<input type="checkbox" name="" class="ui-checkbox" id="799" onClick="Compare.add(this, 799,'<?php echo $goodsInfo['goods_name']; ?>','0', '__INDEX__/img/0_thumb_G_1490174858999.jpg', '68', '<em>¥</em>81.60')">
                </a>
            </div>
...
<div class="si-warp">
        ...
        <div class="summary-basic-info">
            ...
            <?php if(is_array($radioAttr) || $radioAttr instanceof \think\Collection || $radioAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$radioAttrs): $mod = ($i % 2 );++$i;?>
                <div class="summary-item is-integral">
                    <div class="si-tit"><?php echo $radioAttrs[0]['attr_name'];?></div>
                    <div class="si-warp">
                        <?php if(is_array($radioAttrs) || $radioAttrs instanceof \think\Collection || $radioAttrs instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$radios): $mod = ($i % 2 );++$i;?>
                            <label <?php if($i == 1): ?>class="radiochecked"<?php endif; ?>><input <?php if($i == 1): ?>checked="checked"<?php endif; ?> name="attr_<?php echo $radios['attr_id']; ?>" type="radio" value="<?php echo $radios['id']; ?>"/><?php echo $radios['attr_values']; ?><i></i></label>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
...
<span>库存&nbsp;<em id="goods_attr_num" ectype="goods_attr_num"></em>&nbsp;个</span>
        ...
        <a href="javascript:bool=0;addToCart(<?php echo $goodsInfo['goods_id']; ?>)" data-type="0" class="btn-buynow" ectype="btn-buynow">立即购买</a>
    <a href="javascript:bool=0;addToCartShowDiv(<?php echo $goodsInfo['goods_id']; ?>)" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
...
<div class="gm-floors" ectype="gm-floors">
    <div class="gm-f-item gm-f-details" ectype="gm-item">
        ...
        <div class="goods-para-list">
            <dl class="goods-para">
                <?php if(is_array($onlyAttr) || $onlyAttr instanceof \think\Collection || $onlyAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $onlyAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$onlyAttr): $mod = ($i % 2 );++$i;?>
                    <dd class="column"><span><?php echo $onlyAttr['attr_name']; ?>：<?php echo $onlyAttr['attr_values']; ?></span></dd>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </dl>
        </div>
...
<script type="text/javascript" src="__INDEX__/css/perfect-scrollbar.min.js"></script>
...
<script>
    var goodsid = <?php echo $goodsInfo['goods_id']; ?>;
    //获取计算后的商品会员价格
    $.ajax({
        type:'POST',
        url:"<?php echo url('index/goods/getGoodsMemberPrice'); ?>",
