<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wamp64\www\shopp/application/index\view\flow\flow1.html";i:1532442164;s:61:"D:\wamp64\www\shopp/application/index\view\common\footer.html";i:1531621520;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="__INDEX__/css/perfect-scrollbar.min.css" />
    <script>
        //购物车计算路径
        var ajax_cart_goods_amount = "<?php echo url('index/Flow/ajaxAartGoodsAmount'); ?>";
    </script>
</head>
        ...
        <!--购物车列表开始-->
            <div class="cart-item" ectype="shopItem">
                <div class="item-list" ectype="itemList">
                    <?php if(is_array($goodsCartList) || $goodsCartList instanceof \think\Collection || $goodsCartList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsCartList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsCartList): $mod = ($i % 2 );++$i;?>
                        <div class="item-single">
                           <div class="item-item selected" ectype="item" id="product_<?php echo $goodsCartList['goods_id']; ?>" data-goodsid="<?php echo $goodsCartList['goods_id']; ?>">
                                <div class="item-form">
                                    <div class="cell s-checkbox">
                                        <div class="cart-checkbox" ectype="ckList">
                                            <input type="checkbox" id="checkItem_<?php echo $goodsCartList['goods_id']; ?>" value="<?php echo $goodsCartList['goods_id']; ?>" name="checkItem" class="ui-checkbox" ectype="ckGoods"/>
                                            <label for="checkItem_<?php echo $goodsCartList['goods_id']; ?>" class="ui-label-14">&nbsp;</label>
                                         </div>
                                    </div>
                                    <div class="cell s-goods">
                                        <div class="goods-item">
                                            <div class="p-img">
                                                <a href="#" target="_blank"><img src="__UPLOADS__/<?php echo $goodsCartList['md_thumb']; ?>" width="70" height="70" /></a>
                                            </div>
                                            <div class="item-msg">
                                                <a href="#" target="_blank"><?php echo $goodsCartList['goods_name']; ?></a>
                                                <div class="gds-types"></div>
                                            </div>
                                         </div>
                                    </div>

                                     <div class="cell s-props"><?php echo $goodsCartList['goods_attrs_res']; ?></div>
                                      <div class="cell s-price">
                                          <strong id="goods_price_7"><em>¥</em><?php echo $goodsCartList['member_price']; ?></strong>
                                      </div>
                                      <div class="cell s-quantity">
                                            <div class="amount-warp">
                                                <input type="text" value="<?php echo $goodsCartList['goods_num']; ?>" name="goods_number[8]" id="goods_number_8" onchange="change_goods_number(7, this.value, 2, 16)" class="text buy-num" ectype="number" defaultnumber="<?php echo $goodsCartList['goods_num']; ?>">
                                                <div class="a-btn">
