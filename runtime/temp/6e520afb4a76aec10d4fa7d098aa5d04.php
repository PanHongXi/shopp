<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\wamp64\www\shopp/application/index\view\index\index.html";i:1532350388;s:61:"D:\wamp64\www\shopp/application/index\view\Common\header.html";i:1531574270;s:61:"D:\wamp64\www\shopp/application/index\view\Common\footer.html";i:1531621520;}*/ ?>
<!doctype html>
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="Keywords" content="<?php echo $confRes['site_keywords']; ?>" />
	<meta name="Description" content="<?php echo $confRes['site_describe']; ?>" />
...
<div class="top-banner" style="background: rgb(255, 40, 125) none repeat scroll 0% 0%;">
	...
	<div class="spec" data-spec="{&quot;picHeight&quot;:&quot;500&quot;,&quot;target&quot;:&quot;_blank&quot;,&quot;navColor&quot;:&quot;#ff287d&quot;,&quot;is_li&quot;:0,&quot;bg_color&quot;:[],&quot;pic_src&quot;:[&quot;./img/1494985021864887905.jpg&quot;],&quot;link&quot;:&quot;&quot;,&quot;sort&quot;:[&quot;1&quot;]}"></div>
</div>
<div class="site-nav" id="site-nav">
    <div class="w <?php if(isset($show_right)) { echo 'w1200'; } else { echo 'w1390';} ?>">
        ...
        <ul class="quick-menu fr">
            <ul class="quick-menu fr">
                <?php if(is_array($navRes['1']) || $navRes['1'] instanceof \think\Collection || $navRes['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $navRes['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav_top): $mod = ($i % 2 );++$i;?>
                <li>
                    <div class="dt"><a <?php if($nav_top['nav_open'] == 1): ?> target="_blank" <?php endif; ?> href="<?php echo $nav_top['nav_url']; ?>"><?php echo $nav_top['nav_name']; ?></a></div>
                </li>
...
<div class="header">
    <div class="w <?php if(isset($show_right)) { echo 'w1200'; } else { echo 'w1390';} ?>">
        <div class="logo">
            <div class="logoImg" style="font-size: 20px;color: #0e93e0"><a href="<?php echo url('index/index/index'); ?>"><img src="__INDEX__/img/logo1.png"/>云琰商城</a></div>
        </div>
    ...
    <div class="w <?php if(isset($show_right)) { echo 'w1200'; } else { echo 'w1390';} ?>">
        <div class="categorys <?php if(!isset($show_nav)) { echo 'site-mast';} ?>">
            ...
            <div class="categorys-tab-content">
                <div class="categorys-items" id="cata-nav">
                    <?php if(is_array($goodsClassList) || $goodsClassList instanceof \think\Collection || $goodsClassList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsClassList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <div class="categorys-item" ectype="cateItem" data-id="<?php echo $item['id']; ?>" data-eveval="0">
                            <div class="item item-content">
                                <i class="iconfont <?php echo $item['iconfont']; ?>"></i>
                                <div class="categorys-title">
                                    <strong>
                                        <a href="<?php echo url('index/Category/category', array('id'=>$item['id'])); ?>" target="_blank"><?php echo $item['class_name']; ?></a>
                                    </strong>
                                    <span>
                                        <?php if(is_array($item['children']) || $item['children'] instanceof \think\Collection || $item['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item1): $mod = ($i % 2 );++$i;if($i < 3): ?>
                                                <a href="<?php echo url('index/Category/category', array('id'=>$item1['id'])); ?>" target="_blank"><?php echo $item1['class_name']; ?></a>
                            ...
                            <div class="categorys-items-layer" ectype="cateLayer">
                                <div class="cate-layer-con clearfix">
                                    <div class="cate-layer-left">
                                        <div class="cate_channel" ectype="channels_<?php echo $item['id']; ?>"></div>
                                        <div class="cate_detail" ectype="subitems_<?php echo $item['id']; ?>"></div>
                                    </div>
                                    <div class="cate-layer-rihgt" ectype="brands_<?php echo $item['id']; ?>"></div>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </div>
        ...
        <div class="nav-main" id="nav">
            <ul class="navitems">
                ...
                <?php if(is_array($navRes['2']) || $navRes['2'] instanceof \think\Collection || $navRes['2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $navRes['2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav_mid): $mod = ($i % 2 );++$i;?>
                    <li><a <?php if($nav_mid['nav_open'] == 1): ?> target="_blank" <?php endif; ?> href="<?php echo $nav_mid['nav_url']; ?>"><?php echo $nav_mid['nav_name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
    </div>
	...
	<div class="content" style="min-height: 974px;"><div class="visual-item" data-mode="lunbo" data-purebox="banner" data-li="1" data-length="5" ectype="visualItme" style="display: block;" data-diff="0">
		<div class="view">
			<div class="banner home-banner">
				<div class="bd">
					<ul data-type="range">
						<?php if(is_array($broadList) || $broadList instanceof \think\Collection || $broadList instanceof \think\Paginator): $i = 0; $__LIST__ = $broadList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$broadList): $mod = ($i % 2 );++$i;?>
							<li style="background:url(__IMG__/<?php echo $broadList['thumb']; ?>) center center no-repeat;"><div class="banner-width"><a href="<?php echo $broadList['link_url']; ?>" target="_blank" style="height:500px;"></a></div></li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					...
					<div class="vip-con">
						<div class="insertVipEdit" data-mode="insertVipEdit">
							...
							<div class="vip-item">
								...
								<div class="con">
									<ul>
										<?php if(is_array($homeNotice) || $homeNotice instanceof \think\Collection || $homeNotice instanceof \think\Paginator): $i = 0; $__LIST__ = $homeNotice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($i % 2 );++$i;?>
											<li><a href="<?php echo url('index/Article/index',array('id'=>$notice['id'])); ?>" target="_blank"><?php echo $notice['article_title']; ?></a></li>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
									<ul style="display:none;">
										<?php if(is_array($homeSales) || $homeSales instanceof \think\Collection || $homeSales instanceof \think\Paginator): $i = 0; $__LIST__ = $homeSales;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sales): $mod = ($i % 2 );++$i;?>
											<li><a href="<?php echo url('index/Article/index',array('id'=>$sales['id'])); ?>" target="_blank"><?php echo $sales['article_title']; ?></a></li>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
								</div>
							</div>
		...
		<div class="visual-item w1200" ectype="channel"><div class="seckill-channel" id="h-seckill">
			...
			<input value="1" name="seckill_goods" type="hidden">
		</div>
		<div class="visual-item w1200" data-mode="h-need" data-purebox="homeAdv" data-li="1" ectype="visualItme" data-diff="0" style="display: block;">
			<div class="view">
				<div class="need-channel clearfix" id="h-need_0" data-type="range" data-lift="推荐">
					<div class="channel-column" style="background:url(/shopp/public/static/index/img/1494984987302153402.jpg) no-repeat;">
					...
					<div class="channel-column" style="background:url(/shopp/public/static/index/img/1494984989930757668.jpg) no-repeat;">
						<div class="column-title">
					...
					<div class="channel-column" style="background:url(/shopp/public/static/index/img/1494984989391013089.jpg) no-repeat;">
						<div class="column-title">
					...
					<div class="channel-column" style="background:url(/shopp/public/static/index/img/1494984987606903394.jpg) no-repeat;">
						<div class="column-title">
					...
					<div class="channel-column" style="background:url(/shopp/public/static/index/img/1494984990175755536.jpg) no-repeat;">
						<div class="column-title">
				...
				<div class="brand-channel clearfix" id="h-brand_0" data-type="range" data-lift="品牌">
					...
					<div ectype="homeBrand">
						<div class="brand-list" id="recommend_brands">
							<a href="javascript:void(0);" ectype="changeBrand" id="refresh-btn" class="refresh-btn"><i class="iconfont icon-rotate-alt"></i>
								<span>换一批</span></a>
						</div>
					</div>
		...
		<!--推荐分类开始-->
		<?php foreach($homeClassList as $k => $v): ?>
				...
				<div class="floor-content" data-type="range" id="homeFloor_0" data-lift="女装">
					<div class="floor-line-con floorOne floor-color-type-1" data-title="男装女装" data-idx="1" id="floor_1" ectype="floorItem">
						<div class="floor-hd" ectype="floorTit">
							<i class="box_hd_arrow"></i>
							<i class="box_hd_dec"></i>
							<div class="hd-tit"><?php echo $v['class_name'];?></div>
							<div class="hd-tags">
								<ul>
									...
									<?php foreach($v['children'] as $k1 => $v1):?>
										<li data-catgoods="" class="first" ectype="floor_cat_content" data-flooreveval="0" data-visualhome="1" data-floornum="6" data-id="<?php echo $v1['id'];?>">
											<span><?php echo $v1['class_name'];?></span>
											<i class="arrowImg"></i>
										</li>
									<?php endforeach;?>
								</ul>
						...
						<div class="floor-bd bd-mode-01">
							<div class="bd-left">
								<div class="floor-left-slide">
									<div class="bd">
										<ul>
											<?php foreach($v['newRecPositionA'] as $ka => $va):?>
												<li><a href="<?php echo $va['link_url'];?>"><img src="__IMG__/<?php echo $va['img_url'];?>"></a></li>
											<?php endforeach;?>
										</ul>
									</div>
									<div class="hd"><ul></ul></div>
								...
								<div class="floor-left-adv">
									<?php foreach($v['newRecPositionB'] as $kb => $vb):?>
										<a href="<?php echo $vb['link_url'];?>" target="_blank"><img src="__IMG__/<?php echo $vb['img_url'];?>"></a>
									<?php endforeach;?>
								</div>
							</div>
							<div class="bd-right">
								<div class="floor-tabs-content clearfix">
										...
										<ul class="p-list">
											<?php foreach($v['newRecGoods'] as $k2 => $v2):?>
												<li class="opacity_img">
													<div class="product">
														<div class="p-img"><a href="<?php echo url('index/goods/goodsDetails'); ?>?goodsid=<?php echo $v2['goods_id'];?>" target="_blank"><img src="__UPLOADS__/<?php echo $v2['md_thumb'];?>" width="140" height="140"></a></div>
														<div class="p-name"><a href="goods.php?id=<?php echo $v2['goods_id'];?>" title="<?php echo $v2['goods_name'];?>"><?php echo $v2['goods_name'];?></a></div>
														<div class="p-price">
									...
									<?php foreach($v['children'] as $k1 => $v1):?>
										<div class="f-r-main">
											<ul class="p-list">
												<?php foreach($v1['bestRecGoods'] as $k2 => $v2):?>
												<li class="opacity_img">
													<div class="product">
														<div class="p-img"><a href="<?php echo url('index/goods/goodsDetails'); ?>?goodsid=<?php echo $v2['goods_id'];?>" target="_blank"><img src="__UPLOADS__/<?php echo $v2['md_thumb'];?>" width="140" height="140"></a></div>
														<div class="p-name"><a href="<?php echo url('index/goods/goodsDetails'); ?>?goodsid=<?php echo $v2['goods_id'];?>" title="<?php echo $v2['goods_name'] ;?>"><?php echo $v2['goods_name'];?></a></div>
														<div class="p-price">
															<span class="shop-price"><em>¥</em><?php echo $v2['shop_price'];?> </span>
															<span class="original-price"><em>¥</em><?php echo $v2['markte_price'];?></span>
														</div>
						...
						<div class="floor-fd">
							<div class="floor-fd-brand clearfix">
								<?php foreach($v['newRecBrands']['brands'] as $k1 => $v1):?>
									<div class="item">
										<a href="brandn.php?id=<?php echo $v1['brand_id'] ;?>" target="_blank">
											<div class="link-l"></div>
											<div class="img"><img src="__IMG__/<?php echo $v1['thumb'] ;?>" title="<?php echo $v1['brand_name'] ;?>"></div>
											<div class="link"></div>
										</a>
									</div>
								<?php endforeach;?>
			...
			<div class="view">
				<div class="master-channel" id="h-master_0" data-type="range" data-lift="达人">
					...
					<div class="master-con">
						<div class="m-c-item m-c-i-1" style="background:url(/shopp/public/static/index/img/1494985006295599886.jpg) center center no-repeat;">
							<div class="m-c-main">
								<div class="title">
									<h3>纯棉质品</h3>
									<span>把好货带回家</span>
							...
							<div class="img"><a href="" target="_blank"><img src="__INDEX__/img/1494985002918483191.png"></a></div>
						</div>
						<div class="m-c-item m-c-i-2" style="background:url(/shopp/public/static/index/img/1494985006392060862.jpg) center center no-repeat;">
							<div class="m-c-main">
								<div class="title">
									<h3>团购热卖</h3>
									<span>每一款都是好货</span>
							...
							<div class="img"><a href="" target="_blank"><img src="__INDEX__/img/1494985002435254172.png"></a></div>
						</div>
						<div class="m-c-item m-c-i-3" style="background:url(/shopp/public/static/index/img/1494985006452127966.jpg) center center no-repeat;">
							<div class="m-c-main">
								<div class="title">
									<h3>团购热卖</h3>
									<span>都是好货</span>
							...
							<div class="img"><a href="" target="_blank"><img src="__INDEX__/img/1494985003577610926.png"></a></div>
						</div>
						<div class="m-c-item m-c-i-4" style="background:url(/shopp/public/static/index/img/1494985006427221958.jpg) center center no-repeat;">
							<div class="m-c-main">
								<div class="title">
									<h3>舒适童鞋</h3>
									<span>帮宝宝学走路</span>
							...
							<div class="img"><a href="" target="_blank"><img src="__INDEX__/img/1494985003958834850.png"></a></div>
						</div>
						<div class="m-c-item m-c-i-5" style="background:url(/shopp/public/static/index/img/1494985005357290375.jpg) center center no-repeat;">
							<div class="m-c-main">
								<div class="title">
									<h3>双十二运动鞋</h3>
									<span>品牌直降</span>
							...
							<div class="img"><a href="" target="_blank"><img src="__INDEX__/img/1494985004056329811.png"></a></div>
						</div>
					</div>
					...
					<div class="rec-store-list">
						<div class="rec-store-item opacity_img">
							<a href="" target="_blank">
								<div class="p-img"><img src="__INDEX__/img/1494985261279846913.png"></div>
								<div class="info">
									<div class="s-logo"><div class="img"><img src="__INDEX__/img/1494985267980096546.png"></div></div>
									<div class="s-title">
						...
						<div class="rec-store-item opacity_img">
							<a href="" target="_blank">
								<div class="p-img"><img src="__INDEX__/img/1494985257347489575.png"></div>
								<div class="info">
									<div class="s-logo"><div class="img"><img src="__INDEX__/img/1494985265619204005.png"></div></div>
									<div class="s-title">
						...
						<div class="rec-store-item opacity_img">
							<a href="" target="_blank">
								<div class="p-img"><img src="__INDEX__/img/1494985254811159847.png"></div>
								<div class="info">
									<div class="s-logo"><div class="img"><img src="__INDEX__/img/1494985265516324065.png"></div></div>
									<div class="s-title">
						...
						<div class="rec-store-item opacity_img">
							<a href="" target="_blank">
								<div class="p-img"><img src="__INDEX__/img/1494985263326444094.png"></div>
								<div class="info">
									<div class="s-logo"><div class="img"><img src="__INDEX__/img/1494985267537609679.jpg"></div></div>
									<div class="s-title">
		...
		<div class="visual-item w1200" data-mode="guessYouLike" data-purebox="goods" ectype="visualItme" data-diff="0" style="display: block;">
			<div class="view">
				<div class="lift-channel clearfix" id="guessYouLike" data-type="range" data-lift="商品">
					...
					<ul>
						<?php foreach($homeRecList['goodsInfo'] as $k=> $v):?>
							<li class="opacity_img">
								<a href="<?php echo url('index/goods/goodsDetails'); ?>?goodsid=<?php echo $v['goods_id'];?>" target="_blank">
									<div class="p-img"><img src="__UPLOADS__/<?php echo $v['md_thumb'];?>"></div>
									<div class="p-name" title="<?php echo $v['goods_name'];?>"><?php echo $v['goods_name'];?></div>
									<div class="p-price">
										<div class="shop-price">
											<em>¥</em><?php echo $v['shop_price'];?>
										</div>
										<div class="original-price">
											<span class="original-price"><em>¥</em><?php echo $v['markte_price'];?></span>
										</div>
									</div>
								</a>
							</li>
                    ...
                    <div class="help-item">
                        ...
                        <ul>
                            <?php if(is_array($cate['arts']) || $cate['arts'] instanceof \think\Collection || $cate['arts'] instanceof \think\Paginator): $i = 0; $__LIST__ = $cate['arts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arts): $mod = ($i % 2 );++$i;?>
                                <li><a href=" <?php if($arts["link_url"]): ?><?php echo $arts['link_url']; else: ?> <?php echo url('index/Article/index', array('id'=>$arts['id'])); endif; ?>"><?php echo $arts['article_title']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="footer-new-bot">
        <div class="w w1200">
            <p class="copyright_links">
                <a href="http://localhost/shopp/index.php">首页</a>
                <?php if(is_array($helpShoppRes) || $helpShoppRes instanceof \think\Collection || $helpShoppRes instanceof \think\Paginator): $i = 0; $__LIST__ = $helpShoppRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$helpShoppRes): $mod = ($i % 2 );++$i;?>
                    <span class="spacer"></span>
                    <a href="<?php echo url('index/Article/index', array('id'=>$helpShoppRes['id'])); ?>"><?php echo $helpShoppRes['article_title']; ?></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </p>
            <p><span>©&nbsp;2015-2017&nbsp;版权所有&nbsp;&nbsp;</span><span>ICP备案证书号:</span><a href="#">粤ICP备18023582号</a>&nbsp;</p>
...
<script>
    ...
    var regUrl = "<?php echo url('member/Account/reg'); ?>";
...
<script type="text/javascript">
    var page = 1;
    var brand_url = "<?php echo url('index/Brand/brandList'); ?>";
    $(function () {
